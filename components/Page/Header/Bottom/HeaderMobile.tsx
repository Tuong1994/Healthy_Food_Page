    ...
    <React.Fragment>
      ...
      <Drawer open={open} head={<Logo />} onClose={handleClose} bodyClassName="header-mobile-side">
        ...
        <Row justify="between">
          ...
          <Col>
            <Space>
              <span className={`side-lang ${activeClassName(ELang.EN)}`} onClick={() => switchLang(ELang.EN)}>
                EN
              </span>
              <span className={`side-lang ${activeClassName(ELang.VN)}`} onClick={() => switchLang(ELang.VN)}>
                VN
              </span>
            </Space>
          </Col>
