...
const AboutStory: React.FC<AboutStoryProps> = ({ lang }) => {
  const stories = [
    ...
    },
    {
      ...
      position: lang.about.story.owner,
      img: "/logo/customer/liliiput.svg",
    },
    {
      id: "3",
    ...
    },
    {
      ...
      img: "/logo/customer/tangerine.webp",
    },
  ];
